...
res = minimize(fun_obj, x, args=(), method='SLSQP', jac='2-point', constraints=[c1], options={'ftol':0.01,'maxiter':50,'eps':0.01,'finite_diff_rel_step': 0.01,'iprint': 3, 'disp': True}, bounds=bounds)
#print("res=",res)
